    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div>
              <!--<form action="<?php echo base_url('super_wage/search_cd')?>" class="form-horizontal" method="post" role="form">-->
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date form_datetime col-md-5" data-date-format="yyyy-mm" data-link-field="dtp_input1">
                    ...
                    <span class="input-group-btn"><a href="<?php echo base_url('super_wage/wage_team_import') ?>" class="btn btn-warning" style="width:80px;margin-left:5px">上传</a></span>
...
<script type="text/javascript">
    $(document).ready(function() {
      $("#zqteamMainMenu").addClass('active');
