    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div>
              <!--<form action="<?php echo base_url('super_wage/search_sale')?>" class="form-horizontal" method="post" role="form">-->
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date form_datetime col-md-5" data-date-format="yyyy-mm" data-link-field="dtp_input1">
                    ...
                    <span class="input-group-btn"><a href="<?php echo base_url('super_wage/wage_sale_import') ?>" class="btn btn-warning" style="width:80px;margin-left:5px">上传</a></span>
            ...
            <hr />
            <?php if($chosen_month): ?>
            <h4>中山联通<?php echo date_format(date_create($chosen_month),"Y年m月");?>C、D岗信息明细</h4>
            <hr />
            <?php endif;?>
              ...
              <table id="wageTable"class="table table-striped table-bordered table-responsive" style="white-space:nowrap;text-align: center;border-color:silver;">
                <thead>
                  <tr>
                    ...
                    <?php if($v!="" and $k!="date_tag" and $k!="sheet_tag"):?>
                ...
                <tbody>
                  ...
                  <?php foreach($wage as $a => $b): ?>
                    ...
                    <?php foreach($b as $k => $v): ?>
                      <?php if($k!="date_tag" and $k!="sheet_tag" and $counterdata<$counter):?>
...
<script type="text/javascript">
    $(document).ready(function() {
      $("#zqsaleMainMenu").addClass('active');
