              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date form_datetime col-md-5" data-date-format="yyyy-mm" data-link-field="dtp_input1">
                    ...
                    <span class="input-group-btn"><a href="<?php echo base_url('super_wage/wage_cd_import') ?>" class="btn btn-warning" style="width:80px;margin-left:5px">上传</a></span>
